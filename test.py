...
# Import do GamePad/JoyPad (controle)
from nes_py.wrappers import JoypadSpace
# Import dos movimentos simplificados
from gym_super_mario_bros.actions import SIMPLE_MOVEMENT

# Conexão entre Game e JoyPad
...
for step in range(5000):
    if done:
        state = env.reset()
    # Realiza ações aleatórias
    state, reward, done, boolean, info = env.step(env.action_space.sample())
    # Mostra o game na tela
    env.render()
# Termina o game
env.close()
